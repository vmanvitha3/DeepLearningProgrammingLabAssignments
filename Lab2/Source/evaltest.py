...
# Data Parameters
tf.flags.DEFINE_string("data_file", "./data/test-release.txt", "Data source for add lable.")

# Eval Parameters
tf.flags.DEFINE_integer("batch_size", 64, "Batch Size (default: 64)")
tf.flags.DEFINE_string("checkpoint_dir", "./runs/1524533511/checkpoints/", "Checkpoint directory from training run")
